    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50/40">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-10">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 px-6 py-3 text-center border-t border-gray-100">
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6 sm:p-8 mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4 bg-purple-50 rounded-2xl p-4 border border-purple-100">
              <div className="w-10 h-10 bg-purple-500 text-white rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0 mt-0.5">
                2
              </div>
              <div>
            ...
            <div className="flex items-start gap-4 bg-emerald-50 rounded-2xl p-4 border border-emerald-100">
              <div className="w-10 h-10 bg-emerald-500 text-white rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0 mt-0.5">
                3
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <a
            ...
            className="group bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-2xl p-6 text-center transition shadow-lg shadow-blue-200"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white rounded-2xl p-6 text-center transition shadow-lg shadow-emerald-200"
          >
            <div className="text-4xl mb-2">💬</div>
...
export default PinyinStartPage;