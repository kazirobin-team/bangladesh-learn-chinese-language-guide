...
import { DownloadLibrary, NoticeTemplates, PdfViewer, StudentTemplate } from "../components/resources/ResourceLibrary";
  ...
  return (
    <main>
      ...
      <div className="resources-page site-container">
        <DownloadLibrary /><PdfViewer /><NoticeTemplates /><StudentTemplate />
